...
<table class="details">
		<tbody>
			<tr>
				<td style="border-bottom: none;"><img src="https://rndelectro.ru/upload/CMax/690/xybrxc51v2yummmig3gsadkcbon9jwdd.jpg" width="190px" height="auto" alt="Логотип компании ПрофЭлектро с изображением капли и шестерёнки" class="header__logo-image" /></td>
				<tr>
...
$dompdf->stream('Прайс-лист товаров профэлектро');
