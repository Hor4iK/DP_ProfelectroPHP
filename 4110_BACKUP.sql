...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 13 2024 г., 02:24
...
CREATE TABLE `goods` (
  ...
  `good_podcategory_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `podcategory` (
  `podcategory_id` int UNSIGNED NOT NULL,
  `podcategory_name` varchar(255) DEFAULT NULL,
  `podcategory_affiliation` int DEFAULT NULL,
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1498;
...
--
ALTER TABLE `goods`
  MODIFY `good_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;

--
-- AUTO_INCREMENT для таблицы `podcategory`
--
ALTER TABLE `podcategory`
  MODIFY `podcategory_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
