...
<body class="page">
  ...
  <header class="header">
    <div class="header__menu-section menu">
      <a href="#" class="header__menu-section-link">
    ...
    <div class="sidebar-menu__block-list top-menu">
      <ul class="sidebar-menu__list">
        ...
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=2" class="sidebar-menu__content header__list-item-link">
            Водоотведение
          </a>
        </li>
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=3" class="sidebar-menu__content header__list-item-link">
            Освещение
          </a>
        </li>
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=4" class="sidebar-menu__content header__list-item-link">
            Инструменты
          </a>
        </li>
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=5" class="sidebar-menu__content header__list-item-link">
            Экипировка, средства защиты
          </a>
        </li>
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=6" class="sidebar-menu__content header__list-item-link">
            Электрический тёплый пол
          </a>
        </li>
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=8" class="sidebar-menu__content header__list-item-link">
            Сантехника
          </a>
        </li>
        <li class="sidebar-menu_list-item">
          <a href="./content/catalog.php?Value=9" class="sidebar-menu__content header__list-item-link">
            Краски
          </a>
        </li>
        <li class="sidebar-menu_list-item ">
          <a href="./content/catalog.php?Value=10" class="sidebar-menu__content header__list-item-link">
            Газовое оборудование
          </a>
        </li>
        <li class="sidebar-menu_list-item list-item_option">
          <a href="./content/catalog.php?Value=0" class="sidebar-menu__content header__list-item-link list-item-link__accent">
            Каталог
          </a>
        </li>
        <li class="sidebar-menu_list-item list-item_option">
        ...
        <li class="sidebar-menu_list-item list-item_option">
          <a href="./content/about.php" class="sidebar-menu__content header__list-item-link list-item-link__accent">
            О компании
          </a>
        </li>
        <li class="sidebar-menu_list-item list-item_option">
          <a href="./content/contacts.php" class="sidebar-menu__content header__list-item-link list-item-link__accent">
            Контакты
          </a>
        </li>
        <li class="sidebar-menu_list-item">
    ...
    <nav class="header__menu-list-block">
      ...
      <ul class="header__menu-list">
        ...
        <li class="header__list-item type__hiding">
          <a href="./content/about.php" class="header__list-item-link">О компании</a>
        </li>
        <li class="header__list-item type__hiding">
          <a href="./content/contacts.php" class="header__list-item-link">Контакты</a>
        </li>
  ...
  <main class="main" id="main">
    ...
    <section class="content">
      <div class="content__wrapper">
        <div class="content__about content__section">
          <ul class="content__about-list">
            ...
            <li class="about__card-item">
              <img src="/img/contact.svg" class="about__icon" />
              <h5 class="about__card-title">Клиентский сервис</h5>
              <p class="about__card-paragraph">
                Отвечаем на вопросы покупателей в течение 10 минут
              </p>
            </li>
            <li class="about__card-item">
              <img src="/img/garantiya.svg" class="about__icon" />
              <h5 class="about__card-title">Гарантия качества</h5>
              <p class="about__card-paragraph">
                Соответствуем требованиям и стандартам качества
              </p>
            </li>
            <li class="about__card-item">
              <img src="/img/kesh.svg" class="about__icon" />
              <h5 class="about__card-title">Доступные цены</h5>
              <p class="about__card-paragraph">
        ...
        <div class="content__big-cards">
          <ul class="big-cards__list">
            <li class="big-cards__list-item">
              <a href="./content/catalog.php?Value=6" class="big-cards__link">
                <img loading="lazy" src="/img/warm-floor.png" alt="Плитка изображена в разрезе, где видно устройство тёплого пола" class="big-cards__image" />
                <h5 class="big-cards__title">Тёплые полы</h5>
                <span class="big-cards__description">Удобство и комфорт</span>
              </a>
            </li>
            <li class="big-cards__list-item">
              <a href="./content/catalog.php?Value=3&Podcategory=14" class="big-cards__link">
                <img loading="lazy" src="https://static.insales-cdn.com/images/products/1/600/233710168/TL90220.jpg" alt="Белая настольная лампа с дисплеем времени на ножке" class="big-cards__image" />
                <h5 class="big-cards__title">Настольные светильники</h5>
                <span class="big-cards__description">Красота и уют</span>
              </a>
            </li>
          </ul>
        </div>
