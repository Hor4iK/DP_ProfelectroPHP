...
<body class="page">
  ...
  <main class="content">
    ...
    <div class="conteiner-text">
      <div class="conteiner-text__about" id="payment">
        <h2>О компании</h2>
        <p>Магазин, который сделает ваш дом уютным.</p>
        <p>
          Профэлектро – оптово-розничный магазин товаров и услуг для ремонта и
          домашнего интерьера. Всё необходимое в одном месте – Профэлектро
          собрал все необходимое, избавляя клиентов от проблем бесконечного
          поиска, сравнения и принятия решений. Работая с 2005 года, мы
          досконально изучили все потребности и желания клиента, поэтому
          готовы предлагать наиболее подходящие варианты.
        </p>
        <h2>Наш ассортимент</h2>
        <p>
          В ассортименте магазина представлены все категории товаров, которые
          необходимы для полноценных ремонтных или отделочных работ:
          электротовары и сантехника, крепежи и кухонные принадлежности,
          освещение и инструменты, текстиль и постельное белье, а также многое
          другое.
        </p>
        <h2>Наши преимущества</h2>
        <p>
          Выгодное сотрудничество. Лучшие прорабы и мастера организуют все
          этапы ремонтных и монтажных работ. Быстрая доставка – купленные
          товары будут у вас в течение 24 часов. Бонусы за покупки – множество
          акций, скидок и подарков ежедневно. Ответим на все ваши вопросы в
          течение 10 минут. Мы работаем напрямую с лучшими отечественными
          поставщиками: дистрибьютерами и заводами-производителями.
        </p>
        <h2>Как нас найти?</h2>
        <p>Физический адрес магазина: село Новобатайск, улица Ленина, 61.</p>
        <h2>Юридический адрес:</h2>
        <p>ОГРНИП 316619600141326 ИНН 616803355621</p>
        <p>Свидетельство 61№007785000 от 19.05.2016 г.</p>
        <p>344103, г. Ростов-на-Дону, ул. Мечетинская, дом №85</p>
        <p>ОКПО 0102394857 ОКВЭД 52.45</p>
      </div>
    </div>
  </main>
  <footer class="footer">
