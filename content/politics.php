...
<body class="page">
  ...
  <main class="content">
    ...
    <div class="conteiner-text">
      <div class="conteiner-text__about politics">
        <h2>Соглашение на обработку персональных данных</h2>
        <p>Согласие на обработку персональных данных 16.12.2020</p>
        <p>
          Физическое лицо, именуемый в дальнейшем «Субъект персональных
          данных» разрешает Индивидуальному предпринимателю Назыровой
          Екатерине Александровне, в лице ответственного за обработку
          персональных данных далее «Оператор», обработку персональных данных,
          приведенных в пункте 2 настоящего согласия на следующих условиях:
        </p>
        <p>
          1. В соответствии со статьей 9 Федерального закона от 27.07.2006 №
          152-ФЗ «О персональных данных» субъект персональных данных дает
          согласие на обработку Оператором своих персональных данных, с целью:
          исполнения договора-оферты; в целях ведения финансово-хозяйственной
          деятельности организации; иное (необходимо точное указание целей).
        </p>
        <p>
          2. Перечень персональных данных, на обработку которых дается
          согласие (нужное подчеркнуть): дата и место рождения; биографические
          сведения; сведения о месте регистрации, проживании; контактная
          информация; иное (необходимо точное указание).
        </p>
        <p>
          3. Оператор вправе осуществлять следующие действия с указанными выше
          персональными данными путем автоматизированной обработки и обработки
          без использования средств автоматизации (нужное подчеркнуть): сбор;
          систематизацию; накопление; хранение; уточнение (обновление,
          изменение); использование; распространение/передачу; блокирование;
          уничтожение; иное (необходимо точное указание).
        </p>
        <p>
          4. Субъект персональных данных имеет право на доступ к его
          персональным данным в порядке, определенном статьей 14 Федерального
          закона от 27.07.2006 № 152-ФЗ «О персональных данных».
        </p>
        <p>
          5. Срок действия данного согласия устанавливается на период: с
          16.12.2020 бессрочно.
        </p>
        <p>
          6. Согласие может быть отозвано мною в любое время на основании
          моего письменного заявления.
        </p>
        <p>
          Данные об операторе персональных данных: Наименование организации
          Индивидуальный предприниматель Назырова Екатерина Александровна
          Адрес оператора 344103, г. Ростов-на-Дону, ул. Мечетинская, 85
