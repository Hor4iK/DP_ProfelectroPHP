...
<body class="page">
  ...
  <header class="header">
    ...
    <nav class="header__menu-list-block">
      ...
      <ul class="header__menu-list">
        ...
        <li class="header__list-item type__hiding">
          <a class="header__list-item-link">Контакты</a>
        </li>
  ...
  <main class="content">
    ...
    <div class="content__block content__block__contact">
      <div class="content__block__text">
        <h1>Расположение магазинов</h1>
        <p class="content__block__text-address-block">
          село Новобатайск, ул. Ленина 61 Пн. – Пт.: с 8:00 до 18:00 Суб. -
          Вос.: с 9:00 до 15:00
        </p>
        <p class="content__block__text-address-block">
          г. Ростов-на-Дону, ул. Еременко 99 Пн. – Пт.: с 8:00 до 18:00 Суб. -
          Вос.: с 9:00 до 15:00
        </p>
        <p class="content__block__text-address-block">
          г. Ростов-на-Дону, ул. Сиверса 28а Пн. – Пт.: с 8:00 до 18:00 Суб.: с 9:00 до 15:00 Воскресенье выходной
        </p>
        <p class="content__block__text-address-block">
          г. Батайск, ул. Куйбышева 108 Пн. – Пт.: с 8:00 до 18:00 Суб.: с
          9:00 до 15:00 Воскресенье выходной
        </p>
        <div class="content__block__text-contacts">
          <p class="content__block__text-contacts-title">телефон</p>
          <p>8-908-193-50-43, 8-950-843-60-64</p>
        </div>
        <div class="content__block__text-contacts">
          <p class="content__block__text-contacts-title">e-mail</p>
          <p>kettlin_94@mail.ru</p>
        </div>
      </div>
      <div class="content__block__contact__map">
